...
namespace Wardrobe_MVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,Photo,Type,Color,IsSummer,IsFall,IsWinter,IsSpring,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,Photo,Type,Color,IsSummer,IsFall,IsWinter,IsSpring,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
