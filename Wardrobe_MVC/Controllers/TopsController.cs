...
namespace Wardrobe_MVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,Photo,Type,Color,IsSummer,IsFall,IsWinter,IsSpring,Occasion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,Photo,Type,Color,IsSummer,IsFall,IsWinter,IsSpring,Occasion")] Top top)
        {
            if (ModelState.IsValid)
            {
